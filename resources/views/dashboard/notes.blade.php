                ...
                <table class="table table-striped table-primary">
                    ...
                    <tbody>
                        @foreach($notes as $note)
                            <tr>
                                <th scope="row">{{ $note?->id ?? '0'}}</th>
                                <td>{{ $note?->title ?? 'this note has no title'}}</td>
                                <td>{{ $note->author?->name ?? 'this note has no name'}}</td>
                                <td>{{ $note->created_at?->format('M d, Y') ?? 'unknown date'}}</td>
                                <td>
